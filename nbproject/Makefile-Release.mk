...
${OBJECTDIR}/QAppNG/CCassClient.o: QAppNG/CCassClient.cpp 
	...
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/QAppNG/CCassClient.o QAppNG/CCassClient.cpp

${OBJECTDIR}/QAppNG/Imsi.o: QAppNG/Imsi.cpp 
	${MKDIR} -p ${OBJECTDIR}/QAppNG
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/QAppNG/Imsi.o QAppNG/Imsi.cpp

${OBJECTDIR}/QAppNG/LightWeightSequencerEvo.o: QAppNG/LightWeightSequencerEvo.cpp 
	${MKDIR} -p ${OBJECTDIR}/QAppNG
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/QAppNG/LightWeightSequencerEvo.o QAppNG/LightWeightSequencerEvo.cpp

${OBJECTDIR}/QAppNG/PeriodicTimer.o: QAppNG/PeriodicTimer.cpp 
	${MKDIR} -p ${OBJECTDIR}/QAppNG
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/QAppNG/PeriodicTimer.o QAppNG/PeriodicTimer.cpp

${OBJECTDIR}/QAppNG/PipedProcess.o: QAppNG/PipedProcess.cpp 
	${MKDIR} -p ${OBJECTDIR}/QAppNG
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/QAppNG/PipedProcess.o QAppNG/PipedProcess.cpp

${OBJECTDIR}/QAppNG/QStatusManager.o: QAppNG/QStatusManager.cpp 
	${MKDIR} -p ${OBJECTDIR}/QAppNG
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/QAppNG/QStatusManager.o QAppNG/QStatusManager.cpp

${OBJECTDIR}/QAppNG/QVirtualClock.o: QAppNG/QVirtualClock.cpp 
	${MKDIR} -p ${OBJECTDIR}/QAppNG
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/QAppNG/QVirtualClock.o QAppNG/QVirtualClock.cpp

${OBJECTDIR}/QAppNG/TablesHandler.o: QAppNG/TablesHandler.cpp 
	${MKDIR} -p ${OBJECTDIR}/QAppNG
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/QAppNG/TablesHandler.o QAppNG/TablesHandler.cpp

${OBJECTDIR}/QAppNG/TablesRenderer.o: QAppNG/TablesRenderer.cpp 
	${MKDIR} -p ${OBJECTDIR}/QAppNG
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/QAppNG/TablesRenderer.o QAppNG/TablesRenderer.cpp

${OBJECTDIR}/QAppNG/ThreadCounter.o: QAppNG/ThreadCounter.cpp 
	${MKDIR} -p ${OBJECTDIR}/QAppNG
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/QAppNG/ThreadCounter.o QAppNG/ThreadCounter.cpp

${OBJECTDIR}/QAppNG/TicketsCommonMethods.o: QAppNG/TicketsCommonMethods.cpp 
	${MKDIR} -p ${OBJECTDIR}/QAppNG
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/QAppNG/TicketsCommonMethods.o QAppNG/TicketsCommonMethods.cpp

${OBJECTDIR}/QAppNG/TrivialCircularLockFreeQueueEvo.o: QAppNG/TrivialCircularLockFreeQueueEvo.cpp 
	${MKDIR} -p ${OBJECTDIR}/QAppNG
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/QAppNG/TrivialCircularLockFreeQueueEvo.o QAppNG/TrivialCircularLockFreeQueueEvo.cpp

${OBJECTDIR}/QAppNG/WorkManager.o: QAppNG/WorkManager.cpp 
	${MKDIR} -p ${OBJECTDIR}/QAppNG
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/QAppNG/WorkManager.o QAppNG/WorkManager.cpp

${OBJECTDIR}/QAppNG/WorkManagerStatus.o: QAppNG/WorkManagerStatus.cpp 
	${MKDIR} -p ${OBJECTDIR}/QAppNG
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/QAppNG/WorkManagerStatus.o QAppNG/WorkManagerStatus.cpp

${OBJECTDIR}/QAppNG/nl_clockable_time.o: QAppNG/nl_clockable_time.cpp 
	${MKDIR} -p ${OBJECTDIR}/QAppNG
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/QAppNG/nl_clockable_time.o QAppNG/nl_clockable_time.cpp

${OBJECTDIR}/QAppNG/nl_osal.o: QAppNG/nl_osal.cpp 
	${MKDIR} -p ${OBJECTDIR}/QAppNG
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/QAppNG/nl_osal.o QAppNG/nl_osal.cpp
...
${OBJECTDIR}/pugixml/pugixml.o: pugixml/pugixml.cpp 
	...
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/pugixml/pugixml.o pugixml/pugixml.cpp
